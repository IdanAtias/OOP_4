...
import OOP.Tests.NivTests.Interfaces.I63;
import OOP.Tests.NivTests.Interfaces.I62;
/*
...
public class BadClassTest2 {
	...
	@Test
	public void weakerAccessWithSpacesTest() {
		Boolean caught = false;
		String expected = null;
		try{
			Method badMethod = I62.class.getMethod("f", null);
			expected = new OOPBadClass(badMethod).getMessage();
		}catch (Throwable e){
			e.printStackTrace();
			fail("Unexpected excpetion in reflection. This would probably never happen.");
		...
		try {
			generator.generateMultipleClass(I63.class);
		}
		catch (OOPBadClass e){
			caught = true;
			assertTrue("Wrong Message",expected.equals(e.getMessage()));
